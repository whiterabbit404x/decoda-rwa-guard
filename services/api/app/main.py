...
def ops_monitoring_runtime_status(request: Request) -> dict[str, Any]:
    try:
        ...
        canonical_runtime = {
            ...
            'monitored_systems': int(payload.get('monitored_systems') or payload.get('configured_systems') or 0),
            ...
            'next_required_action': str(summary.get('next_required_action') or payload.get('next_required_action') or 'review_reason_codes'),
