...
def monitoring_runtime_status(request: Request | None = None) -> dict[str, Any]:
    ...
    logger.info(
        'monitoring_workspace_runtime_truth workspace_id=%s reporting_systems=%s configured_systems=%s evidence_source=%s telemetry_kind=%s last_coverage_telemetry_at=%s status_reason=%s',
        workspace_id,
        reporting_systems,
        enabled_system_count,
        evidence_source,
        summary.get('telemetry_kind'),
