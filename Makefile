...
generate-github-zip-proof:
	python scripts/proof/write_github_zip_proof.py

sell-now-proof: generate-live-evidence-proof generate-github-zip-proof
	python scripts/proof/write_sell_now_proof.py
