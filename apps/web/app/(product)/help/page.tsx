    ...
    <main className="productPage">
      <section className="featureSection">
        ...
        <div className="threeColumnSection">
          <article className="dataCard"><h2>1) Create workspace</h2><p className="muted">Create/select your workspace and confirm billing plan.</p><Link href="/workspaces" prefetch={false}>Open workspaces</Link></article>
