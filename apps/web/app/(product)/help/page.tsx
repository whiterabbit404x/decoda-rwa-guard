    ...
    <main className="productPage">
      <section className="featureSection">
        ...
        <div className="threeColumnSection">
          <article className="dataCard"><h2>1) Create workspace</h2><p className="muted">Create/select your workspace and complete self-serve onboarding (billing can be enabled later).</p><Link href="/workspaces">Open workspaces</Link></article>
